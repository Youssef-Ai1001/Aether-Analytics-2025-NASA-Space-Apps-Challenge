...
<meta name="csrf-token" content="CypxZTVhRWXXwQhWssEtawGHOnEFKAu2q__hgYxS7c3TVOWSdRjhojOEOTiycY465sOIZTh1BS7XCCFPGNw4mg" />
  ...
  <form id="login" action="/login" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="rVXuzj7iXv1AQWUD3BTP6tCr8YLGBhQTX_ivPj2dIvF1K3o5fpv6OqQEVG3cpGy7N-9DlvtbGosjD2_wqRP3pg" autocomplete="off" />
  <p>
  ...
  <p>
    <input type="hidden" name="redirect_uri" id="redirect_uri" value="https://harmony.earthdata.nasa.gov/oauth2/redirect" autocomplete="off" />
      ...
      <p><input type="hidden" name="state" id="state" value="edb17f3d136867a5c44cd5a691b87a25" autocomplete="off" /></p>
...
<aside class="govt-msg">
  ...
  <p>
    ...
    <div class="idfs-button-alignment">
          ...
          <a class="eui-btn--round eui-btn--blue" href="/users/new?client_id=WocHIn_ABQ9FFxjAKTF5LQ&amp;redirect_uri=https%3A%2F%2Fharmony.earthdata.nasa.gov%2Foauth2%2Fredirect&amp;response_type=code&amp;state=edb17f3d136867a5c44cd5a691b87a25">Register for a Profile</a>
    <div>
</aside>
