...
<meta name="csrf-token" content="J28vkF9CsoA8y325uk7-oyVsjdV-U2uAuhiAoHila5ZcA5g2Jz-RxuESQ4sc-2D4VO1VaINQhZTc-ysavH6Scw" />
  ...
  <form id="login" action="/login" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="4Vyz_FhXcd98quYZi0SjHujc8Hs7D2WJ95wwqjsLZk6aMARaICpSmaFz2Cst8T1FmV0oxsYMi52Rf5sQ_9Cfqw" autocomplete="off" />
  <p>
  ...
  <p>
    <input type="hidden" name="client_id" id="client_id" value="WocHIn_ABQ9FFxjAKTF5LQ" autocomplete="off" />
  </p>
  <p>
    <input type="hidden" name="redirect_uri" id="redirect_uri" value="https://harmony.earthdata.nasa.gov/oauth2/redirect" autocomplete="off" />
  </p>
        <p><input type="hidden" name="response_type" id="response_type" value="code" autocomplete="off" /></p>
      <p><input type="hidden" name="state" id="state" value="7980b680a427f9a065cdb1fd6008d6e9" autocomplete="off" /></p>
...
<aside class="govt-msg">
  ...
  <p>
    ...
    <div class="idfs-button-alignment">
          ...
          <a class="eui-btn--round eui-btn--blue" href="/users/new?client_id=WocHIn_ABQ9FFxjAKTF5LQ&amp;redirect_uri=https%3A%2F%2Fharmony.earthdata.nasa.gov%2Foauth2%2Fredirect&amp;response_type=code&amp;state=7980b680a427f9a065cdb1fd6008d6e9">Register for a Profile</a>
    <div>
</aside>
